...
# ── CSS: True Full-Screen Terminal + Fixed Sticky Bottom Command Dock ──
st.markdown("""
<style>
    ...
    /* Terminal output fills the entire screen height down to the input dock */
    .terminal-output {
...
# ══════════════════════════════════════════════════════
# RENDER: Full Viewport Continuous Display
# ══════════════════════════════════════════════════════

st.title("💻 Elite Terminal Console")

# ── Terminal Output (Fills entire screen height) ──
