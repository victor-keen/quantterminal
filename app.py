...
# ── CSS: Single continuous terminal + bottom input ──
st.markdown("""
<style>
    .stApp {
    ...
    .terminal-output {
        ...
        padding: 1.2rem;
        font-family: 'Consolas', 'DejaVu Sans Mono', 'Courier New', monospace !important;
        color: #58a6ff;
        font-size: 13px;
        line-height: 1.3;
...
def execute_module():
    ...
    # Pad with "0" to safely exit nested menus
    feed = list(cmds) + ["0"]
    ...
    # Capture figures as PNG bytes (reliable, no SVG rendering issues)
...
# ── Terminal Output (scrollable, auto-scroll to bottom) ──
...
# ── Charts (rendered inline below terminal, before input) ──
...
# ── Command Input Bar (always at the bottom) ──
